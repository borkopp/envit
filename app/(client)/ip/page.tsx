  ...
  return (
    <div className="container mx-auto px-6 md:px-16 lg:px-24 py-10">
      ...
      <p className="text-lg mb-8">
        ...
        Pb and other toxic metals from soil. However, more than 20-years of
        research by many groups worldwide has not resulted in a feasible
        solution for EDTA recycling, for the problem of vast amounts of
        generated waste waters and for toxic emission due to EDTA environmental
        persistence. ReSoil resolves all these problems. It is an
      ...
      <div className="mb-12">
        ...
        <div className="mb-8">
          <ul className="list-disc list-inside mb-4">
            <li>
              <Link
                href="https://patents.google.com/patent/US9108233B2"
            ...
            <li>
              <Link
                href="https://patents.google.com/patent/EP3153246B1"
                className="text-blue-500 hover:underline"
              >
            ...
            <li>
              <Link
                href="https://patents.google.com/patent/GB201720126D0"
                className="text-blue-500 hover:underline"
              >
                Curbing toxic emissions from remediated substrate, GB 201720126
                D0
              </Link>
            </li>
            <li>
              <Link
                href="https://patents.google.com/patent/WO2022184903A1"
                className="text-blue-500 hover:underline"
              >
                Removal of arsenic, antimony and toxic metals from contaminated
                substrate, WO2022184903A1
              </Link>
            </li>
          </ul>
        </div>
