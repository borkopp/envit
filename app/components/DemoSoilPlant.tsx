  ...
  return (
    <section className="py-16 bg-white" id="project">
      ...
      <div className="space-y-4 items-center text-center mb-14">
          <h3 data-aos="fade-up" className="text-sm font-bold uppercase tracking-wide text-primary">Soil Plant</h3>
          <h2 data-aos="fade-up" data-aos-delay="100" className="text-4xl font-semibold tracking-tighter sm:text-4xl">Soil Plant Demonstration</h2>
