    ...
    <section className="relative py-12 sm:py-16 md:py-24">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="space-y-4 items-center text-center mb-8 sm:mb-14">
          <h3 className="text-sm font-bold uppercase tracking-wide text-emerald-800/80">
            Awards
          </h3>
          <h2 
            data-aos="fade-up" 
            data-aos-delay="100"
            className="text-3xl sm:text-4xl text-emerald-900 font-semibold tracking-tighter"
          >
            Recognition & Awards
          </h2>
          <p 
