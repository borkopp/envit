    ...
    const fetchCaseStudies = async () => {
      ...
      const transformedCards = result.map((study: CaseStudy) => ({
        ...
        content: () => {
          return (
            <div>
              <p className="mb-4 font-semibold text-neutral-700 dark:text-neutral-300">
          ...
          <div className="w-full lg:w-[40%]">
            <div className="sticky top-20">
              ...
              <p className="text-sm text-center lg:text-left mx-auto lg:mx-0 text-neutral-600 dark:text-neutral-400 mt-6 max-w-sm">
                Discover how we&apos;ve helped transform contaminated sites into
                thriving environments through innovative soil remediation
                solutions.
              </p>
            </div>
          </div>
