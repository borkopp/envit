...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex h-[600px] flex-col items-center justify-start overflow-hidden bg-white dark:bg-slate-950 w-full rounded-3xl z-0",
        className
      )}
    >
      <div className="relative flex translate-y-32 w-full h-[300px] scale-y-125 items-center justify-center isolate z-0 ">
        <motion.div
        ...
        <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-green-500 opacity-30 dark:opacity-50 blur-3xl"></div>
        <motion.div
          initial={{ width: "8rem" }}
          ...
          className="absolute inset-auto z-30 h-36 w-64 -translate-y-[6rem] rounded-full bg-green-400 opacity-40 dark:opacity-60 blur-2xl"
        ></motion.div>
        <motion.div
          initial={{ width: "15rem" }}
          ...
          className="absolute inset-auto z-50 h-0.5 w-[30rem] -translate-y-[7rem] bg-green-400 dark:bg-green-400"
        ></motion.div>

        <div className="absolute inset-auto z-40 h-44 w-full -translate-y-[12.5rem] bg-white dark:bg-slate-950"></div>
      </div>

      <div className="relative z-50 flex -translate-y-12 flex-col items-center px-5 flex-1">
        {children}
      </div>
    </div>
  );
